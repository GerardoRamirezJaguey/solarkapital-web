...
// Datos específicos para la página Corporativa
const datos = {
  testimonios: [
    ...
    { nombre: "Gerente de Proyectos, Fondo de Inversión", texto: "La capacidad técnica y financiera de Solarkapital para ejecutar parques solares a gran escala es de primer nivel. Un socio confiable." }
  ]
};
    ...
    <div className="bg-black text-white">
      ...
      <section className="relative h-screen -mt-24 flex items-center justify-center text-center" style={{ backgroundImage: `url(${heroImage})`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
        ...
        <div className="relative z-10 px-4">
          ...
          <Link to="/#contacto" className="bg-yellow-400 text-black font-bold py-3 px-6 rounded-lg hover:bg-yellow-500 transition-colors">Contactar a un Estratega</Link>
        </div>
      </section>
      ...
      <section className="py-20 bg-gray-900">
        <div className="container mx-auto px-4 grid md:grid-cols-2 gap-12 items-center">
          <div className="text-center md:text-left">
            ...
            <p className="text-gray-400 mb-6">Explora nuestros modelos financieros, incluyendo Power Purchase Agreements (PPA), para implementar energía solar a gran escala sin descapitalizar tu empresa y asegurando costos energéticos a largo plazo.</p>
            <Link to="/#contacto" className="bg-yellow-400 text-black font-bold py-3 px-6 rounded-lg hover:bg-yellow-500 transition-colors">Explorar Modelos Financieros</Link>
          </div>
          <div>
            <GraficaAhorro />
          </div>
      ...
      {/* --- HISTORIAS DE ÉXITO CORPORATIVAS --- */}
      <section className="py-20 bg-gray-900">
