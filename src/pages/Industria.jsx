...
const datos = {
  testimonios: [
    ...
    { nombre: "Director Financiero, Grupo Industrial", texto: "El retorno de inversión fue más rápido de lo proyectado. Es el proyecto de capital más rentable que hemos ejecutado." },
    ...
    <div className="bg-black text-white">
      <section className="relative h-screen -mt-24 flex items-center justify-center text-center" style={{ backgroundImage: `url(${heroImage})`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
        ...
        <div className="relative z-10 px-4">
          ...
          {/* BOTÓN ACTUALIZADO */}
          <Link to="/simulador" className="bg-yellow-400 text-black font-bold py-3 px-6 rounded-lg hover:bg-yellow-500 transition-colors">Analizar mi Viabilidad</Link>
        </div>
      </section>
      ...
      <section className="py-20 bg-gray-900">
        <div className="container mx-auto px-4 grid md:grid-cols-2 gap-12 items-center">
          <div className="text-center md:text-left">
            ...
            <p className="text-gray-400 mb-6">Fija tus costos energéticos por los próximos 25 años y olvídate de la volatilidad de las tarifas eléctricas. Asegura la continuidad de tu operación.</p>
            {/* BOTÓN ACTUALIZADO */}
            <Link to="/simulador" className="bg-yellow-400 text-black font-bold py-3 px-6 rounded-lg hover:bg-yellow-500 transition-colors">Calcular ROI Industrial</Link>
          </div>
          <div>
            <GraficaAhorro />
          </div>
