    ...
    <div className="bg-black text-white">
      <section className="relative h-screen -mt-24 flex items-center justify-center text-center" style={{ backgroundImage: `url(${heroImage})`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
        ...
        <div className="relative z-10 px-4">
          ...
          {/* BOTÓN ACTUALIZADO */}
          <Link to="/simulador" className="bg-yellow-400 text-black font-bold py-3 px-6 rounded-lg hover:bg-yellow-500 transition-colors">Solicitar Estudio Gratuito</Link>
        </div>
      </section>
      ...
      <section className="py-20 bg-gray-900">
        <div className="container mx-auto px-4 grid md:grid-cols-2 gap-12 items-center">
          <div className="text-center md:text-left">
            ...
            {/* BOTÓN ACTUALIZADO */}
            <Link to="/simulador" className="bg-yellow-400 text-black font-bold py-3 px-6 rounded-lg hover:bg-yellow-500 transition-colors">Simula el ROI de tu empresa</Link>
          </div>
          <div>
            <GraficaAhorro />
          </div>
